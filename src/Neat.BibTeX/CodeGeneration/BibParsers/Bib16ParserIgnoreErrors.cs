...
{
  public sealed class Bib16ParserIgnoreErrors
  {
    private struct Overrides : IBib16ParserUnsafeOverrides<Overrides>
    {
#if BIB_PARSER_CATCH_ERRORS
      ...
      [MethodImpl(Helper.JustOptimize)]
      private Bib16String SaveString()
      {
        Bib16String result;
        List2<Bib16StringComponent> components = StringComponents;
        if (components.Count < 2)
        {
          result = new Bib16String(components[0]);
        }
        else
        {
          result = new Bib16String(components.ToArray());
        }
        return result;
      }
      ...
      public int SaveEntryType(ref Bib16ParserUnsafe<Overrides> that, ref PrimitiveCharT start, int length)
      {
        ...
        if (BibBstComparer.Equals(entryType, Bib16PreambleEntry.EntryType))
        {
#if BIB_PARSER_CATCH_ERRORS
#else
          EntryTypeCode = 2;
        ...
        if (BibBstComparer.Equals(entryType, Bib16GeneralEntry.CommentEntryType))
        {
#if BIB_PARSER_CATCH_ERRORS
#else
          EntryTypeCode = 3;
      ...
      public void SaveStringEntry(ref Bib16ParserUnsafe<Overrides> that)
      {
        Entries.Add(new Bib16StringEntry(EntryType, that.EntryIsBrace, StringNameOrFieldName, SaveString()));
      }

      [MethodImpl(Helper.OptimizeInline)]
      public void SavePreambleEntry(ref Bib16ParserUnsafe<Overrides> that)
      {
        Entries.Add(new Bib16PreambleEntry(EntryType, that.EntryIsBrace, SaveString()));
      }

      [MethodImpl(Helper.OptimizeInline)]
      public void SaveGeneralEntry(ref Bib16ParserUnsafe<Overrides> that)
      {
        Entries.Add(new Bib16GeneralEntry(EntryType, that.EntryIsBrace, DatabaseKey, Fields.ToArray()));
      }
      ...
      [MethodImpl(Helper.OptimizeInline)]
      public void SaveNameComponent(ref Bib16ParserUnsafe<Overrides> that, ref PrimitiveCharT start, int length)
      {
      ...
      [MethodImpl(Helper.OptimizeInline)]
      public void SaveQuoteLiteralComponent(ref Bib16ParserUnsafe<Overrides> that, ref PrimitiveCharT start, int length)
      {
        StringComponents.Add(new Bib16StringComponent(
      ...
      [MethodImpl(Helper.OptimizeInline)]
      public void SaveNumericLiteralComponent(ref Bib16ParserUnsafe<Overrides> that, ref PrimitiveCharT start, int length)
      {
        StringComponents.Add(new Bib16StringComponent(
      ...
      [MethodImpl(Helper.OptimizeInline)]
      public void SaveBraceLiteralComponent(ref Bib16ParserUnsafe<Overrides> that, ref PrimitiveCharT start, int length)
      {
        StringComponents.Add(new Bib16StringComponent(
      ...
      [MethodImpl(Helper.OptimizeInline)]
      public void SaveDatabaseKey(ref Bib16ParserUnsafe<Overrides> that, ref PrimitiveCharT start, int length)
      {
      ...
      [MethodImpl(Helper.OptimizeInline)]
      public void SaveField(ref Bib16ParserUnsafe<Overrides> that)
      {
        Fields.Add(new Bib16Field(StringNameOrFieldName, SaveString()));
      }
      ...
      public void EntryExpectingType(ref Bib16ParserUnsafe<Overrides> that)
      {
#if BIB_PARSER_CATCH_ERRORS
      ...
      [MethodImpl(ForExceptionMethods)]
      public void StringEntryExpectingOpen(ref Bib16ParserUnsafe<Overrides> that)
      {
#if BIB_PARSER_CATCH_ERRORS
        throw new BibParserException(string.Format(CultureInfo.InvariantCulture,
      ...
      [MethodImpl(ForExceptionMethods)]
      public void StringEntryExpectingName(ref Bib16ParserUnsafe<Overrides> that)
      {
#if BIB_PARSER_CATCH_ERRORS
        throw new BibParserException(string.Format(CultureInfo.InvariantCulture,
      ...
      [MethodImpl(ForExceptionMethods)]
      public void StringEntryExpectingAssignment(ref Bib16ParserUnsafe<Overrides> that)
      {
#if BIB_PARSER_CATCH_ERRORS
        throw new BibParserException(string.Format(CultureInfo.InvariantCulture,
      ...
      [MethodImpl(ForExceptionMethods)]
      public void StringEntryGotEndOfInput(ref Bib16ParserUnsafe<Overrides> that)
      {
#if BIB_PARSER_CATCH_ERRORS
        throw new BibParserException(string.Format(CultureInfo.InvariantCulture,
      ...
      [MethodImpl(ForExceptionMethods)]
      public void StringEntryExpectingClose(ref Bib16ParserUnsafe<Overrides> that)
      {
#if BIB_PARSER_CATCH_ERRORS
        throw new BibParserException(string.Format(CultureInfo.InvariantCulture,
      ...
      [MethodImpl(ForExceptionMethods)]
      public void PreambleEntryExpectingOpen(ref Bib16ParserUnsafe<Overrides> that)
      {
#if BIB_PARSER_CATCH_ERRORS
        throw new BibParserException(string.Format(CultureInfo.InvariantCulture,
      ...
      [MethodImpl(ForExceptionMethods)]
      public void PreambleEntryGotEndOfInput(ref Bib16ParserUnsafe<Overrides> that)
      {
#if BIB_PARSER_CATCH_ERRORS
        throw new BibParserException(string.Format(CultureInfo.InvariantCulture,
      ...
      [MethodImpl(ForExceptionMethods)]
      public void PreambleEntryExpectingClose(ref Bib16ParserUnsafe<Overrides> that)
      {
#if BIB_PARSER_CATCH_ERRORS
        throw new BibParserException(string.Format(CultureInfo.InvariantCulture,
      ...
      [MethodImpl(ForExceptionMethods)]
      public void GeneralEntryExpectingOpen(ref Bib16ParserUnsafe<Overrides> that)
      {
#if BIB_PARSER_CATCH_ERRORS
        throw new BibParserException(string.Format(CultureInfo.InvariantCulture,
      ...
      [MethodImpl(ForExceptionMethods)]
      public void GeneralEntryExpectingDatabaseKey(ref Bib16ParserUnsafe<Overrides> that)
      {
#if BIB_PARSER_CATCH_ERRORS
        throw new BibParserException(string.Format(CultureInfo.InvariantCulture,
      ...
      [MethodImpl(ForExceptionMethods)]
      public void GeneralEntryExpectingFirstCommaOrClose(ref Bib16ParserUnsafe<Overrides> that)
      {
#if BIB_PARSER_CATCH_ERRORS
        throw new BibParserException(string.Format(CultureInfo.InvariantCulture,
      ...
      [MethodImpl(ForExceptionMethods)]
      public void GeneralEntryExpectingFieldNameOrClose(ref Bib16ParserUnsafe<Overrides> that)
      {
#if BIB_PARSER_CATCH_ERRORS
        throw new BibParserException(string.Format(CultureInfo.InvariantCulture,
      ...
      [MethodImpl(ForExceptionMethods)]
      public void GeneralEntryExpectingAssignment(ref Bib16ParserUnsafe<Overrides> that)
      {
#if BIB_PARSER_CATCH_ERRORS
        throw new BibParserException(string.Format(CultureInfo.InvariantCulture,
      ...
      [MethodImpl(ForExceptionMethods)]
      public void GeneralEntryGotEndOfInput(ref Bib16ParserUnsafe<Overrides> that)
      {
#if BIB_PARSER_CATCH_ERRORS
        throw new BibParserException(string.Format(CultureInfo.InvariantCulture,
      ...
      [MethodImpl(ForExceptionMethods)]
      public void GeneralEntryExpectingCommaOrClose(ref Bib16ParserUnsafe<Overrides> that)
      {
#if BIB_PARSER_CATCH_ERRORS
        throw new BibParserException(string.Format(CultureInfo.InvariantCulture,
      ...
      [MethodImpl(ForExceptionMethods)]
      public void StringExpectingComponent(ref Bib16ParserUnsafe<Overrides> that)
      {
#if BIB_PARSER_CATCH_ERRORS
        throw new BibParserException(string.Format(CultureInfo.InvariantCulture,
      ...
      [MethodImpl(ForExceptionMethods)]
      public void StringQuoteLiteralGotNegativeBraceDepth(ref Bib16ParserUnsafe<Overrides> that)
      {
#if BIB_PARSER_CATCH_ERRORS
        throw new BibParserException(string.Format(CultureInfo.InvariantCulture,
      ...
      [MethodImpl(ForExceptionMethods)]
      public void StringQuoteLiteralGotEndOfInput(ref Bib16ParserUnsafe<Overrides> that)
      {
#if BIB_PARSER_CATCH_ERRORS
        throw new BibParserException(string.Format(CultureInfo.InvariantCulture,
      ...
      [MethodImpl(ForExceptionMethods)]
      public void StringBraceLiteralGotEndOfInput(ref Bib16ParserUnsafe<Overrides> that)
      {
#if BIB_PARSER_CATCH_ERRORS
        throw new BibParserException(string.Format(CultureInfo.InvariantCulture,
    ...
    private Bib16ParserUnsafe<Overrides> myParser;

    public readonly List2<Bib16Entry> Entries;

    [MethodImpl(Helper.JustOptimize)]
    public Bib16ParserIgnoreErrors()
    {
