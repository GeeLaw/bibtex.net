...
namespace Neat.BibTeX.Utils
{
  ...
  public struct Bib8ParserUnsafe<TOverrides> where TOverrides : struct, IBib8ParserUnsafeOverrides<TOverrides>
  {
    ...
    /// This method returns <see langword="true"/> if an exception method was called.
    /// This method does not call <see cref="IBib8ParserUnsafeOverrides{TOverrides}.SaveBraceLiteralComponent(ref Bib8ParserUnsafe{TOverrides}, ref PrimitiveCharT, int)"/>.
    /// </summary>
    [MethodImpl(Helper.JustOptimize)]
    ...
    /// Upon returning from this method (this does not apply if an exception is thrown), <c>data[newEaten]</c> is right at the closing delimiter <c>"</c>.
    /// This method returns <see langword="true"/> if an exception method was called.
    /// This method does not call <see cref="IBib8ParserUnsafeOverrides{TOverrides}.SaveQuoteLiteralComponent(ref Bib8ParserUnsafe{TOverrides}, ref PrimitiveCharT, int)"/>.
    /// </summary>
    [MethodImpl(Helper.JustOptimize)]
