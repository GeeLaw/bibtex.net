...
namespace Neat.BibTeX.Utils
{
  ...
  public struct Bib16ParserUnsafe<TOverrides> where TOverrides : struct, IBib16ParserUnsafeOverrides<TOverrides>
  {
    ...
    /// This method returns <see langword="true"/> if an exception method was called.
    /// This method does not call <see cref="IBib16ParserUnsafeOverrides{TOverrides}.SaveBraceLiteralComponent(ref Bib16ParserUnsafe{TOverrides}, ref PrimitiveCharT, int)"/>.
    /// </summary>
    [MethodImpl(Helper.JustOptimize)]
    ...
    /// Upon returning from this method (this does not apply if an exception is thrown), <c>data[newEaten]</c> is right at the closing delimiter <c>"</c>.
    /// This method returns <see langword="true"/> if an exception method was called.
    /// This method does not call <see cref="IBib16ParserUnsafeOverrides{TOverrides}.SaveQuoteLiteralComponent(ref Bib16ParserUnsafe{TOverrides}, ref PrimitiveCharT, int)"/>.
    /// </summary>
    [MethodImpl(Helper.JustOptimize)]
