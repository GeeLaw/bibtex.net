...
{
  /// <summary>
  /// Customizes BibTeX parsing behaviors of <see cref="Bib16ParserUnsafe{TOverrides}"/>.
  ...
  /// </summary>
  public interface IBib16ParserUnsafeOverrides<TOverrides> where TOverrides : struct, IBib16ParserUnsafeOverrides<TOverrides>
  {
    ...
    int SaveEntryType(ref Bib16ParserUnsafe<TOverrides> that, ref PrimitiveCharT start, int length);

    /// <summary>
    /// Indicates that the parser has seen <c>@string{ name = {literal} # "literal" # 123 # anothername }</c> without error.
    /// When this method is called, <see cref="Bib16ParserUnsafe{TOverrides}.EntryIsBrace"/> indicates whether the string entry uses <c>{}</c> as its delimiters, with the alternate option being <c>()</c>.
    /// </summary>
    void SaveStringEntry(ref Bib16ParserUnsafe<TOverrides> that);

    /// <summary>
    /// Indicates that the parser has seen <c>@preamble{ {literal} # "literal" # 123 # anothername }</c> without error.
    /// When this method is called, <see cref="Bib16ParserUnsafe{TOverrides}.EntryIsBrace"/> indicates whether the preamble entry uses <c>{}</c> as its delimiters, with the alternate option being <c>()</c>.
    /// </summary>
    void SavePreambleEntry(ref Bib16ParserUnsafe<TOverrides> that);

    /// <summary>
    /// Indicates that the parser has seen <c>@type{ key, name1 = {literal} # "literal" # 123 # anothername, ... }</c> without error.
    /// When this method is called, <see cref="Bib16ParserUnsafe{TOverrides}.EntryIsBrace"/> indicates whether the general entry uses <c>{}</c> as its delimiters, with the alternate option being <c>()</c>.
    /// </summary>
    void SaveGeneralEntry(ref Bib16ParserUnsafe<TOverrides> that);

    /// <summary>
    /// Indicates that the parser has seen <c>@string{ name</c>.
    /// When this method is called, <see cref="Bib16ParserUnsafe{TOverrides}.EntryIsBrace"/> indicates whether the string entry uses <c>{}</c> as its delimiters, with the alternate option being <c>()</c>.
    /// </summary>
    void SaveStringName(ref Bib16ParserUnsafe<TOverrides> that, ref PrimitiveCharT start, int length);

    /// <summary>
    /// Indicates that the parser has seen <c>name</c> (e.g., in <c>{literal} # "literal" # 123 # name</c>) without error.
    /// When this method is called, <see cref="Bib16ParserUnsafe{TOverrides}.EntryIsBrace"/> indicates whether the entry uses <c>{}</c> as its delimiters, with the alternate option being <c>()</c>.
    /// </summary>
    void SaveNameComponent(ref Bib16ParserUnsafe<TOverrides> that, ref PrimitiveCharT start, int length);
    ...
    /// When this method is called, <see cref="Bib16ParserUnsafe{TOverrides}.EntryIsBrace"/> indicates whether the entry uses <c>{}</c> as its delimiters, with the alternate option being <c>()</c>.
    /// </summary>
    void SaveQuoteLiteralComponent(ref Bib16ParserUnsafe<TOverrides> that, ref PrimitiveCharT start, int length);

    /// <summary>
    /// Indicates that the parser has seen <c>123</c> (e.g., in <c>{literal} # "literal" # 123</c>) without error.
    /// When this method is called, <see cref="Bib16ParserUnsafe{TOverrides}.EntryIsBrace"/> indicates whether the entry uses <c>{}</c> as its delimiters, with the alternate option being <c>()</c>.
    /// </summary>
    void SaveNumericLiteralComponent(ref Bib16ParserUnsafe<TOverrides> that, ref PrimitiveCharT start, int length);
    ...
    /// When this method is called, <see cref="Bib16ParserUnsafe{TOverrides}.EntryIsBrace"/> indicates whether the entry uses <c>{}</c> as its delimiters, with the alternate option being <c>()</c>.
    /// </summary>
    void SaveBraceLiteralComponent(ref Bib16ParserUnsafe<TOverrides> that, ref PrimitiveCharT start, int length);

    /// <summary>
    /// Indicates that the parser has seen <c>@type{ key</c>.
    /// When this method is called, <see cref="Bib16ParserUnsafe{TOverrides}.EntryIsBrace"/> indicates whether the general entry uses <c>{}</c> as its delimiters, with the alternate option being <c>()</c>.
    /// </summary>
    void SaveDatabaseKey(ref Bib16ParserUnsafe<TOverrides> that, ref PrimitiveCharT start, int length);

    /// <summary>
    /// Indicates that the parser has seen <c>@type{ key, name1</c>.
    /// When this method is called, <see cref="Bib16ParserUnsafe{TOverrides}.EntryIsBrace"/> indicates whether the general entry uses <c>{}</c> as its delimiters, with the alternate option being <c>()</c>.
    /// </summary>
    void SaveFieldName(ref Bib16ParserUnsafe<TOverrides> that, ref PrimitiveCharT start, int length);
    ...
    /// When this method is called, <see cref="Bib16ParserUnsafe{TOverrides}.EntryIsBrace"/> indicates whether the general entry uses <c>{}</c> as its delimiters, with the alternate option being <c>()</c>.
    /// </summary>
    void SaveField(ref Bib16ParserUnsafe<TOverrides> that);
    ...
    /// </summary>
    void EntryExpectingType(ref Bib16ParserUnsafe<TOverrides> that);
    ...
    /// </summary>
    void StringEntryExpectingOpen(ref Bib16ParserUnsafe<TOverrides> that);
    ...
    /// When this method is called, <see cref="Bib16ParserUnsafe{TOverrides}.EntryIsBrace"/> indicates whether the string entry uses <c>{}</c> as its delimiters, with the alternate option being <c>()</c>.
    /// </summary>
    void StringEntryExpectingName(ref Bib16ParserUnsafe<TOverrides> that);
    ...
    /// When this method is called, <see cref="Bib16ParserUnsafe{TOverrides}.EntryIsBrace"/> indicates whether the string entry uses <c>{}</c> as its delimiters, with the alternate option being <c>()</c>.
    /// </summary>
    void StringEntryExpectingAssignment(ref Bib16ParserUnsafe<TOverrides> that);
    ...
    /// </summary>
    void StringEntryGotEndOfInput(ref Bib16ParserUnsafe<TOverrides> that);
    ...
    /// </summary>
    void StringEntryExpectingClose(ref Bib16ParserUnsafe<TOverrides> that);
    ...
    /// the next non-space character is neither <c>{</c> nor <c>(</c>.
    /// </summary>
    void PreambleEntryExpectingOpen(ref Bib16ParserUnsafe<TOverrides> that);
    ...
    /// The original implementation of BibTeX does not save the current entry.
    /// </summary>
    void PreambleEntryGotEndOfInput(ref Bib16ParserUnsafe<TOverrides> that);
    ...
    /// The original implementation of BibTeX saves the current entry.
    /// </summary>
    void PreambleEntryExpectingClose(ref Bib16ParserUnsafe<TOverrides> that);
    ...
    /// the next non-space character is neither <c>{</c> nor <c>(</c>.
    /// </summary>
    void GeneralEntryExpectingOpen(ref Bib16ParserUnsafe<TOverrides> that);
    ...
    /// When this method is called, <see cref="Bib16ParserUnsafe{TOverrides}.EntryIsBrace"/> indicates whether the general entry uses <c>{}</c> as its delimiters, with the alternate option being <c>()</c>.
    /// </summary>
    void GeneralEntryExpectingDatabaseKey(ref Bib16ParserUnsafe<TOverrides> that);
    ...
    /// The original implementation of BibTeX saves the current entry.
    /// </summary>
    void GeneralEntryExpectingFirstCommaOrClose(ref Bib16ParserUnsafe<TOverrides> that);
    ...
    /// </summary>
    void GeneralEntryExpectingFieldNameOrClose(ref Bib16ParserUnsafe<TOverrides> that);
    ...
    /// </summary>
    void GeneralEntryExpectingAssignment(ref Bib16ParserUnsafe<TOverrides> that);
    ...
    /// </summary>
    void GeneralEntryGotEndOfInput(ref Bib16ParserUnsafe<TOverrides> that);
    ...
    /// </summary>
    void GeneralEntryExpectingCommaOrClose(ref Bib16ParserUnsafe<TOverrides> that);
    ...
    /// </summary>
    void StringExpectingComponent(ref Bib16ParserUnsafe<TOverrides> that);
    ...
    /// if the current entry is a general entry, the current field is discarded, but the current entry is saved with all the previously parsed fields.
    /// </summary>
    void StringQuoteLiteralGotNegativeBraceDepth(ref Bib16ParserUnsafe<TOverrides> that);

    /// <summary>
    /// The parser is reading a quote-delimited literal, but
    /// the end of input is reached.
    /// When this method is called, <see cref="Bib16ParserUnsafe{TOverrides}.EntryIsBrace"/> indicates whether the entry uses <c>{}</c> as its delimiters, with the alternate option being <c>()</c>,
    /// and <see cref="Bib16ParserUnsafe{TOverrides}.BraceDepth"/> indicates the number of outstanding left braces.
    /// The original implementation of BibTeX will not save the series of concatenated components, i.e.:
    /// if the current entry is a string entry or a preamble entry, the string entry is discarded;
    /// if the current entry is a general entry, the current field is discarded, but the current entry is saved with all the previously parsed fields.
    /// </summary>
    void StringQuoteLiteralGotEndOfInput(ref Bib16ParserUnsafe<TOverrides> that);

    /// <summary>
    /// The parser is reading a brace-delimited literal, but
    /// the end of input is reached.
    /// When this method is called, <see cref="Bib16ParserUnsafe{TOverrides}.EntryIsBrace"/> indicates whether the entry uses <c>{}</c> as its delimiters, with the alternate option being <c>()</c>,
    /// and <see cref="Bib16ParserUnsafe{TOverrides}.BraceDepth"/> indicates the number of outstanding left braces (not counting the opening delimiter).
    /// The original implementation of BibTeX will not save the series of concatenated components, i.e.:
    /// if the current entry is a string entry or a preamble entry, the string entry is discarded;
    /// if the current entry is a general entry, the current field is discarded, but the current entry is saved with all the previously parsed fields.
    /// </summary>
    void StringBraceLiteralGotEndOfInput(ref Bib16ParserUnsafe<TOverrides> that);
