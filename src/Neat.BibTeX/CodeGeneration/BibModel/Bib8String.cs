...
namespace Neat.BibTeX.BibModel
{
  ...
  /// </summary>
  public readonly struct Bib8String
  {
    /// <summary>
    ...
    /// </summary>
    public readonly Bib8StringComponent OnlyComponent;
    ...
    /// </summary>
    public readonly Bib8StringComponent[] Components;
    ...
    {
      Bib8StringComponent[] components = Components;
    ...
    public Bib8String(Bib8StringComponent onlyComponent)
    {
    ...
    [MethodImpl(Helper.OptimizeInline)]
    public Bib8String(Bib8StringComponent[] components)
    {
      OnlyComponent = default(Bib8StringComponent);
    ...
    internal void CtorCheckImpl(string name)
    {
      ...
      else
      {
        ...
        {
          throw new ArgumentException("Bib8String: Components contains less than 2 items.", name);
        }
        else
        {
          for (int i = 0; i < components.Length; ++i)
